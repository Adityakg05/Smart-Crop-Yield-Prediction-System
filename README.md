...
2. Fill in the environmental and soil parameters
3. Select state and crop type
4. Click "Predict Yield" to get predictions
5. View the predicted yield in tons/hectare
```
